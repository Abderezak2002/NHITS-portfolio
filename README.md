...
- YAML-based configuration (no hardcoded hyperparameters)
- Unit-tested data pipeline with CI (GitHub Actions) (upcoming - undergoing work)
...
```bash
git clone https://github.com/YOUR_USERNAME/N-HITS.git
cd N-HITS
python3 -m venv venv
